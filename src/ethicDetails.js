let ele = JSON.parse(localStorage.getItem('item'))
    ...
    function showImagesOnCart(el) {
        let smallImgContainer = document.querySelector(".small-img-container>img:nth-child(1)").setAttribute("src",ele.image1);
        let selectedImgContainer = document.querySelector(".small-img-container>img:nth-child(1)").classList.add("selected-img");
        document.querySelector(".small-img-container>img:nth-child(2)").setAttribute("src",ele.image);
        ...
        document.querySelector(".target-img-container>img").setAttribute("src",ele.image);
    }
