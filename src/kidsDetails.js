let ele = JSON.parse(localStorage.getItem('item'))
   ...
   function displayBriefInfo(){
    ...
    function productDetails(){
        ...
        <div><h3>Fabric Care</h3><p>${ele.FabricDetails}</p></div>
        <div><h3>Fabric </h3><p>${ele.Fabric}</p></div>
        <div><h3>Size  </h3><p>${ele.Size}</p></div>
        <div><h3>Color</h3><p>${ele.BrandColor}</p></div>
        <div><h3>Suitable </h3><p>${ele.SuitableFor}</p></div>
        `
